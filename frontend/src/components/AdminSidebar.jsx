...
const AdminSidebar = () => {
  const linkStyle = {
    ...
    padding: '10px 16px',
    textDecoration: 'none',
    color: 'var(--link, #3498db)',
    fontWeight: 600,
    fontFamily: "var(--font-sans, 'Poppins', system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif)",
    borderRadius: '4px'
  };
  ...
  return (
    <div style={{
      ...
      <h3 style={{ marginBottom: '20px', fontFamily: "var(--font-sans, 'Poppins', system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif)", fontWeight: 700 }}>Admin Panel</h3>

      <NavLink to="/admin/dashboard" end style={({ isActive }) => (isActive ? activeStyle : linkStyle)}>Overview</NavLink>
      ...
      <NavLink to="/admin/marketing" style={({ isActive }) => (isActive ? activeStyle : linkStyle)}>Marketing</NavLink>
      {/* Rails Metrics are embedded within the Marketing page */}
    </div>
  );
};
